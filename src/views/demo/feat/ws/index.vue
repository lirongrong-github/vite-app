<template>
  <PageWrapper title="WebSocket 示例">
    <div class="lg:flex">
      <div class="lg:w-1/3 bg-white p-4">
        ...
        <div class="flex">
          ...
          <a-button v-if="!getIsOpen" type="primary" @click="toggle"> 开启连接 </a-button>
          <a-button v-else danger @click="toggle"> 关闭连接 </a-button>
        </div>
      ...
      <div class="lg:(w-2/3 ml-4) bg-white p-4 <lg:mt-4">
